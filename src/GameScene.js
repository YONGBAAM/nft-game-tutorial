class GameScene extends Phaser.Scene{
    preload(){
        ...
        this.load.image('block1', 'background/back_jellyfish01.png');
    ...
    create(){
        ...
        this.timer = this.time.addEvent({ delay: this.delay, callback: this.onTimerEvent, callbackScope: this, loop: true });
    ...
    addBlock(){
        ...
        var block1 = this.physics.add.sprite(WIDTH,randomY-randomHeight,'block1').setScale(0.5).setFlipY(true);
        var block2 = this.physics.add.sprite(WIDTH,randomY,'block1').setScale(0.5)
